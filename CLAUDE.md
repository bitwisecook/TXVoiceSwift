...
- If the repository has had no commits for more than 2 weeks, check for updates to the skills files in `.agents/skills/` before starting work.
- If the repository has had no commits for more than 3 days, check for and update any outdated dependencies before starting work.
